...
public class Vinery {
    ...
    public static Block LDV_CHERRY_CHEST = new VariantChestBlock(FabricBlockSettings.copyOf(Blocks.CHEST), VariantChests.LDV_CHERRY);

    public static void registerChests() {
        registerChests(VariantChests.LDV_CHERRY.getId(), LDV_CHERRY_CHEST);
    }
